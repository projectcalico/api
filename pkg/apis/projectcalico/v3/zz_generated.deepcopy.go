...
func (in *CalicoNodeBGPStatus) DeepCopyInto(out *CalicoNodeBGPStatus) {
	*out = *in
	if in.V4Peers != nil {
		in, out := &in.V4Peers, &out.V4Peers
		*out = make([]CalicoNodePeer, len(*in))
		copy(*out, *in)
	}
	if in.V6Peers != nil {
		in, out := &in.V6Peers, &out.V6Peers
		*out = make([]CalicoNodePeer, len(*in))
		copy(*out, *in)
	}
	return
...
func (in *CalicoNodeStatusSpec) DeepCopyInto(out *CalicoNodeStatusSpec) {
	*out = *in
	...
	if in.UpdateIntervalInSeconds != nil {
		in, out := &in.UpdateIntervalInSeconds, &out.UpdateIntervalInSeconds
		*out = new(int)
		**out = **in
	}
	return
