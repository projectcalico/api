...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CalicoNodeRouteStatus) DeepCopyInto(out *CalicoNodeRouteStatus) {
	*out = *in
	if in.V4 != nil {
		in, out := &in.V4, &out.V4
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CalicoNodeRouteStatus.
func (in *CalicoNodeRouteStatus) DeepCopy() *CalicoNodeRouteStatus {
	if in == nil {
		return nil
	}
	out := new(CalicoNodeRouteStatus)
	in.DeepCopyInto(out)
	return out
}
