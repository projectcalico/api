...
type EntityRule struct {
	...
	// ServiceSelector is an optional field that contains options for matching Kubernetes Services.
	...
	//
	// ServiceSelector cannot be specified on the same rule as Selector, NotSelector, Ports,
	// NotPorts, Nets, or NotNets.
	//
