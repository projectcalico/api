		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"services": {
						SchemaProps: spec.SchemaProps{
							Description: "ServiceSelector is an optional field that contains options for matching Kubernetes Services. If specified, only traffic that originates from or terminates at endpoints within the selected service(s) will be matched, and only to/from each endpoint's port.\n\nServiceSelector cannot be specified on the same rule as Selector, NotSelector, Ports, NotPorts, Nets, or NotNets.\n\nOnly valid on egress rules.",
